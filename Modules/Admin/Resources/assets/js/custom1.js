import {checkOptions, names} from './themeColors'
(function ($) {
    "use strict";
    ...
    $(document).on("click", '#myonoffswitch1', function () {
        if (this.checked) {
            ...
            document.querySelector('html').style.removeProperty('--primary-bg-color', localStorage.noadarkPrimary);
            document.querySelector('html').style.removeProperty('--primary-bg-hover', localStorage.noadarkPrimary);
            document.querySelector('html').style.removeProperty('--primary-bg-border', localStorage.noadarkPrimary);
            document.querySelector('html').style.removeProperty('--dark-primary', localStorage.noadarkPrimary);
...
$('#myonoffswitch24').on('click', function () {
    if (this.checked) {
        ...
        (document.getElementById("style").setAttribute("href", "https://crm.alanvaghteshe.com/assets/admin/css/bootstrap.rtl.min.css"));
...
$('#myonoffswitch23').on('click', function () {
    if (this.checked) {
        ...
        $("head link#style").attr("href", $(this));
        (document.getElementById("style").setAttribute("href", "https://cdn.enabz.org/assets/admin/plugins/bootstrap/css/bootstrap.min.css"));
        var carousel = $('.owl-carousel');
        $.each(carousel, function (index, element) {
            // element == this
            var carouselData = $(element).data('owl.carousel');
