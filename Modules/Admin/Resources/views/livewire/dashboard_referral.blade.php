<div>
    <div class="page-header">
        <div>
            <h1 class="page-title">داشبورد پنل مدیریت نمایندگی</h1>
        </div>
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{ $referralStatics['total_benefit'] }}</h3>
                            <p class="text-muted fs-13 mb-0">میزان درآمد</p>
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{ $referralStatics['number_invited_friends'] }}</h3>
                            <p class="text-muted fs-13 mb-0">تعداد افراد معرفی شده	</p>
                            <p class="text-muted mb-0 mt-2 fs-12"><span
                                    class="icn-box text-success fw-semibold fs-13 me-1"> <i class=""></i></span>
                            </p>
                        </div>
        ...
        <div class="col-lg-6 col-sm-12 col-md-6 col-xl-3">
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <h3 class="mb-2 fw-semibold">{{ number_format($referralStatics['successful_referrals']) }}</a></h3>
                            <p class="text-muted fs-13 mb-0">تعداد خرید های انجام شده</p>
                            <p class="text-muted mb-0 mt-2 fs-12"> <span
                                    class="icn-box text-success fw-semibold fs-13 me-1"> <i class=""></i> </span>
                                </p>
                        </div>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="mt-0">
                                                                    ...
                                                                    <p class="mb-0 fs-12 text-muted">
                                                                        ...
                                                                        class="float-end text-dark">{{ number_format($transaction->cost) }}
                                                                        ریال</span> </span>
                                                            </div>
                                                        </div>
                                                    </div>
