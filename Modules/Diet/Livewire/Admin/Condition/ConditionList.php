...
class ConditionList extends Component
{
    ...
    public function delete(Condition $model)
    {
        ...
        return redirect()->route('admin.condition.index')->with('success', ' با موفقیت حذف شد.');
    }
    ...
    {
        $conditions = Condition::when(isset($this->search['id']) && (int) $this->search['id'] !== 0, function ($query) {
        ...
        return view('diet::livewire.admin.condition.condition-list', compact('conditions'));
    }
}
