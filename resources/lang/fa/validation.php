...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'package_id' => 'شماره بسته انتخابی',
        'first_name' => 'نام',
        'last_name' => 'نام خانوادگی',
        'password' => 'کلمه ی عبور',
        'selectedRoles' => 'نقش کاربر',
        "name" => "نام",
        "username" => "نام کاربری",
        ...
        "quantity" => "مقدار",
        "type" => "نوع",
        "form.difficulty" => "سختی",
        "form.foodFact.CALORIE" => "کالری",
        'form.foodFact.PROTEIN' => 'پروتیئین',
        'form.foodFact.FAT'     => 'چربی',
        'form.foodFact.CARBOHYDRATE' => 'کربوهیدرات',
        'form.foodFact.FIBER'   => 'فیبر',
